# Process DEM for ParFlow inputs...
...
#pfsetgrid {315 300 1} {0.0 0.0 0.0} {30.0 30.0 1.0} $dem
...
set pitfill [pfpitfilldem $flatfill 0.001 10000000]
puts stdout "pitfill... Done!"

# Fill dem sinks with moving average routine
set demSmooth [pfmovingavgdem $pitfill 8 20]
