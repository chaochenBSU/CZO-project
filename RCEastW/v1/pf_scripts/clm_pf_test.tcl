...
set ic0     "pf_DrainingTest_step2.out.press.00039.pfb"
# slope files
...
file copy -force     $clmdir/$vegf         .
file copy -force     $clmdir/$meteo        .
file copy -force     $clmdir/$clmin        .
file copy -force     $clmdir/$vegalu       .
...
pfset Solver.MaxIter                                  5000000000 
