...
# Set up run outputs
#-----------------------------------------------------------------------------
exec mkdir "../outputs_1soil_2D_newvege_random"
cd "../outputs_1soil_2D_newvege_random"

# path to clm_input
set clmdir      "../../Parflow_Preprocessing/Distributed_station166_met_2D_1month"
set water_balance_script "/home/cchen/scratch/parflow/RME_200mthick_40_1soil_3D/pf_scripts_clm/WaterBalance_cal.tcl"
set fn "/home/cchen/scratch/parflow/RME_200mthick_40_1soil_3D/pf_scripts_random/stats4.txt"
...
##############################################################
# this section is set up for the radmization
...
pfset Geom.F1.Perm.GeomMean  $kg
pfset Geom.F1.Perm.Sigma  $var
##############################################################
...
pfrun pf_clm_2014RC.$k
pfundist pf_clm_2014RC.$k
...
set press [pfload pf_clm_2014RC.$k.out.press.pfb]
set head [pfhhead $press]
pfsave $head -pfb pf_clm_2014RC.$k.head.pfb
}
