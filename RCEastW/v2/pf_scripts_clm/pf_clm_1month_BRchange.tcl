...
# ----------------------------------------------------------------------------
# ParFlow Input
file copy -force ../parflow_input/RCCZO_RME_DEMfil.sx.pfb .
file copy -force ../parflow_input/RCCZO_RME_DEMfil.sy.pfb .
file copy -force ../parflow_input/origin/geo_indi/NoneSoilRevise/RCCZO_RME_DEMfil.indi.pfb .
# CLM Input
...
# Set up run info
#-----------------------------------------------------------------------------
set runname                               "pf_clm_1month_BRchange"
set rundir                                .
...
set Perm_val_BR                           0.001
set Poros_val_BR                          0.04
...
pfset   Cell.0.dzScale.Value    3
pfset   Cell.1.dzScale.Value    3
pfset   Cell.2.dzScale.Value    3
pfset   Cell.3.dzScale.Value    2.6
pfset   Cell.4.dzScale.Value    2
pfset   Cell.5.dzScale.Value    2
pfset   Cell.6.dzScale.Value    2
pfset   Cell.7.dzScale.Value    2
pfset   Cell.8.dzScale.Value    2
pfset   Cell.9.dzScale.Value    2
pfset   Cell.10.dzScale.Value   1
pfset   Cell.11.dzScale.Value   1
pfset   Cell.12.dzScale.Value   1
pfset   Cell.13.dzScale.Value   1
pfset   Cell.14.dzScale.Value   1
pfset   Cell.15.dzScale.Value   1
pfset   Cell.16.dzScale.Value   1
pfset   Cell.17.dzScale.Value   1
pfset   Cell.18.dzScale.Value   1
pfset   Cell.19.dzScale.Value   1
pfset   Cell.20.dzScale.Value   1
pfset   Cell.21.dzScale.Value   1
pfset   Cell.22.dzScale.Value   1
pfset   Cell.23.dzScale.Value   1
pfset   Cell.24.dzScale.Value   0.4
pfset   Cell.25.dzScale.Value   0.4
pfset   Cell.26.dzScale.Value   0.4
pfset   Cell.27.dzScale.Value   0.32
...
pfset GeomInput.indi_input.GeomNames      "F1 F1F F1S F2 F3"

pfset Geom.indi_input.FileName            $si

pfset GeomInput.F1.Value              0
pfset GeomInput.F1F.Value             1.0
pfset GeomInput.F1S.Value             2.0
...
#-----------------------------------------------------------------------------
pfset Geom.Perm.Names                     "domain F1 F1F F1S F2 F3"
...
# Porosity
#-----------------------------------------------------------------------------
pfset Geom.Porosity.GeomNames             "domain F1 F1F F1S F2 F3"
...
pfset Phase.RelPerm.GeomNames             "domain F1 F1F F1S F2 F3"
...
pfset Phase.Saturation.GeomNames          "domain F1 F1F F1S F2 F3"
