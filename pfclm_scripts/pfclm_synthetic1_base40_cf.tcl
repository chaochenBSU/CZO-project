...
#-----------------------------------------------------------------------------
# set list_name [file join ../outputs_pfclm1_base40 pfclm1_base40.out.press.*.pfb]
...
set end_pfb "../initialcond/pfclm1_base40.out.press.00265.pfb"
set num 265
#-----------------------------------------------------------------------------
# Set up run outputs
#-----------------------------------------------------------------------------
exec mkdir "../outputs_pfclm1_base40"
cd "../outputs_pfclm1_base40"
...
# set ip0      "../initialcond/pf1_base40.out.press.00066.pfb"
