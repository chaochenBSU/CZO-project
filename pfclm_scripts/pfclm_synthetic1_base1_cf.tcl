...
pfset     FileVersion    4
#-----------------------------------------------------------------------------
# Get initial condition .pfb
#-----------------------------------------------------------------------------
# set list_name [file join ../outputs_pfclm1_base1 pfclm1_base1.out.press.*.pfb]
# set pfb_list [glob $list_name]
# set end_pfb [lindex $pfb_list end]
# puts $end_pfb
# set root_name [file rootname $end_pfb]
# set initial_num [lsearch -inline [split $root_name .] {0*}]
# set num_temp [expr [scan $initial_num %d]]
# set num [expr {$num_temp*1}]
# puts $num

set end_pfb "../initialcond/pfclm1_base1.out.press.00092.pfb"
set num 92
#-----------------------------------------------------------------------------
# Set up run outputs
#-----------------------------------------------------------------------------
exec mkdir "../outputs_pfclm1_base1"
cd "../outputs_pfclm1_base1"

# path to clm_input
set clmdir      "../clm_input_c"
# set water_balance_script "/home/cchen/scratch/parflow/RME_200mthick_1_1soil_3D/pf_scripts_clm/WaterBalance_cal.tcl"
...
# set ip0      "../initialcond/pf1_base1.out.press.00095.pfb"
# file copy -force $end_pfb ../initialcond/
set ip0 $end_pfb

# slope files
set sx      "DEMfil_WS1_74.sx.pfb"
set sy      "DEMfil_WS1_74.sy.pfb"
# soil indicator file
set si      "Soil_indi_WS1_base.indi.pfb"
...
# ----------------------------------------------------------------------------
# ParFlow Input
file copy -force ../parflow_input/DEMfil_WS1_74.sx.pfb .
file copy -force ../parflow_input/DEMfil_WS1_74.sy.pfb .
file copy -force ../parflow_input/geo_indi/Soil_indi_WS1_base.indi.pfb .
# CLM Input
file copy -force ../clm_input/drv_vegp.dat          .
file copy -force ../clm_input/narr_1hr_new.txt          .
...
# Set up run info
#-----------------------------------------------------------------------------
set runname                               "pfclm1_base1"
set rundir                                .

set startcount                            $num
set starttime                             [expr {$num*1}]
set stoptime                              336
set istep                                 $num+1
set tstep                                 0.001
set dmpinterval                           1
...
pfset    Cell.1.dzScale.Value    0.0456
pfset    Cell.2.dzScale.Value    0.0228
pfset    Cell.3.dzScale.Value    0.0228
pfset    Cell.4.dzScale.Value    0.0171
pfset    Cell.5.dzScale.Value    0.0057
