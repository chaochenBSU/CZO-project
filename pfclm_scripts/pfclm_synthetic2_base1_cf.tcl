...
#-----------------------------------------------------------------------------
# set list_name [file join ../outputs_pfclm2_base1 pfclm2_base1.out.press.*.pfb]
...
set end_pfb "../initialcond/pfclm2_base1.out.press.00207.pfb"
set num 207
#-----------------------------------------------------------------------------
# Set up run outputs
#-----------------------------------------------------------------------------
exec mkdir "../outputs_pfclm2_base1"
cd "../outputs_pfclm2_base1"
...
# set ip0      "../initialcond/pf2_base1.out.press.00085.pfb"
