...
def get_ws_mask_ser(thick_dom,fn_satur,pfb_poros,m2cm,mask_ws,c,nlayers,sblayer,n):
    ...
    for t in range(sn):
        ...
        np.savetxt('Serial_DCEW_Total.soil_ws.csv',tot_ws_soil , delimiter=",")
    return mask_ws
...
if __name__ == "__main__":
    ...
    thickness = np.array([2.0, ### Bottom
                          ...
                          2.0,
                          1.0,
                          0.2,### Soil Bottom (Soil Starts here from bottom to top)
                          0.1, 
                          0.1,
                          0.1,
                          0.1,
    ...
    fpath = '/media/miguel/Selway/maguayo/OSSEs/30m'
